...
//        tvScore.setText(String.valueOf(level1Score) + "/5");
        ...
        if (prefs.getInt("level", -1) == 0){
            if(leveldone < 20){
                if(level1Score<10){
                    ...
                    //leveldone tries to keep track of when a level needst to be retried
                    //check levelscores
            ...
            switch(leveldone) {
                ...
                case 10:
                    ...
                    //The user has not gotten all of the questions correct and the user must start over level 1
                }
            }else{
                //The user has used all of their chances and the level is done
            }
        }else{
            //the user is not at level 1
        } &&  && ((level1Score <10))) {
            //if the game is at level 1 and the level is not done and the level1Score is less than 10 
        ...
        }else if ((level3Score < 10) && (prefs.getInt("level", -1) == 2)) {
            //If the level is 3 and the level3 score has not reached 10
